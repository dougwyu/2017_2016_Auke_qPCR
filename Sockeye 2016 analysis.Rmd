...
sockqpcrcorrG <- ggplot(sockeye_qpcr_env_adults_use, aes(Date, G_corr_qpcr)) + geom_line() + xlab("") + ylab("qPCR conc*G") + background_grid(major = "x", minor="x", size.minor = 0.5, colour.minor = "grey90")
