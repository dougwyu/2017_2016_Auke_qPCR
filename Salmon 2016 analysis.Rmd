...
sockqpcrcorr <- ggplot(sockeye_qpcr_env_adults_use, aes(Date, Q_corr_Qpcr)) + geom_line() + xlab("") + ylab("qPCR conc * Q") + background_grid(major = "x", minor="x", size.minor = 0.5, colour.minor = "grey90")
