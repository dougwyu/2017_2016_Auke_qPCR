...
sockeye_qpcr_env_adults_use <- sockeye_qpcr_env_adults_A

sockadults <- ggplot(sockeye_qpcr_env_adults_use, aes(Date, SockeyeTotalCount)) + geom_line() + xlab("") + ylab("Adult Counts")
sockqpcr <- ggplot(sockeye_qpcr_env_adults_use, aes(Date, Qty_ng_per_ul_mean)) + geom_line() + xlab("") + ylab("qPCR conc")
sockqpcrcorr <- ggplot(sockeye_qpcr_env_adults_use, aes(Date, Q_corr_Qpcr)) + geom_line() + xlab("") + ylab("qPCR conc * Q")
Q_cfs <- ggplot(sockeye_qpcr_env_adults_use, aes(Date, Q_cfs)) + geom_line() + xlab("") + ylab("Q_cfs")
temp <- ggplot(sockeye_qpcr_env_adults_use, aes(Date, Avg_Temp)) + geom_line() + xlab("") + ylab("Avg Temp")
water <- ggplot(sockeye_qpcr_env_adults_use, aes(Date, Gage_Height)) + geom_line() + xlab("") + ylab("Gage Height")

plot_grid(sockadults, sockqpcr, sockqpcrcorr, Q_cfs, water, temp, nrow = 6, align = "v")
```
