...
ggplot(sockeye_qpcr_env_adults, aes(Date, SockeyeTotalCount)) + geom_line() +
  xlab("") + ylab("Sockeye Adult Counts")
ggplot(sockeye_qpcr_env_adults, aes(Date, Qty_ng_per_ul_mean)) + geom_line() +
  xlab("") + ylab("qPCR concentration")
```
